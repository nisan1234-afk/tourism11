...
- **טרם בוצע כלל** (שלבים 2–5 לפי סדר העדיפויות ב-CONTENT_GUIDE.md): עוזר
  תשובה-פתוחה מתקדם (מפרק פעלי הוראה: ציין/תאר/הסבר/השווה/תכנן, בודק כיסוי מלא
  לפני חשיפת תשובת דוגמה — מבוסס על המחוון של מישור החוף; שלב 2), מצב
